package me.daegyeo.maru.file.adapter.`in`.web

import me.daegyeo.maru.auth.application.domain.CustomUserDetails
import me.daegyeo.maru.file.adapter.`in`.web.dto.FileWebhookDto
import me.daegyeo.maru.file.adapter.`in`.web.dto.GetDownloadPresignedUrlDto
import me.daegyeo.maru.file.adapter.`in`.web.dto.GetUploadPresignedUrlDto
